...
export const appStores = [
  {
    key: 'app-store',
    icon: '/icons/app_store.png',
    title: 'App Store',
    href: '#',
  },
  {
    key: 'google-play',
    icon: '/icons/google_play.png',
    title: 'Google play',
    href: '#',
  },
]
...
export const aboutContents = [
  {
    ...
    description: `Getting around should be simple (and event fun!) for everyone. We embrace technology to provide low cost, smart access to scooters at your fingertips`,
  },
  {
    key: 'content-2',
